...
// trait FactoryCanister<FactoryCanisterKey>: Canister {
//     fn factory_state(&self) -> impl FactoryState<FactoryCanisterKey>;
// }
//
// struct FactoryCanisterInternal {
//     #[id]
//     principal: Principal,
//
...
// /// * set_controller
// /// * refund_icp
// pub trait FactoryCanister {
//     type State: FactoryState;
//
//     fn factory_state(&self) -> Rc<RefCell<Self::State>>;
//
//     fn get_canister_bytecode() -> Vec<u8>;
//
